...
{	
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &AMillionnairePlayerBase::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &AMillionnairePlayerBase::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMillionnairePlayerBase::MoveInput);

		// Looking/Aiming
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMillionnairePlayerBase::LookInput);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AMillionnairePlayerBase::LookInput);
		
		// Inventory binding
		if (InventoryAction)
		{
			EnhancedInputComponent->BindAction(InventoryAction, ETriggerEvent::Started, this, &AMillionnairePlayerBase::OnInventoryPressed);
		}

		// Drop item binding
		if (DropItemAction)
		{
			EnhancedInputComponent->BindAction(DropItemAction, ETriggerEvent::Started, this, &AMillionnairePlayerBase::OnDropItemPressed);
		}
		
		// Interact binding
		if (InteractAction)
		{
			EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Started, this, &AMillionnairePlayerBase::OnInteractPressed);
		}
		
		if (UseHealthAction)
		{
			EnhancedInputComponent->BindAction(UseHealthAction, ETriggerEvent::Started, 
				this, &AMillionnairePlayerBase::OnUseHealthPressed);
		}
		if (UseFoodAction)
		{
			EnhancedInputComponent->BindAction(UseFoodAction, ETriggerEvent::Started, 
				this, &AMillionnairePlayerBase::OnUseFoodPressed);
		}
		if (UseBatteryAction)
		{
			EnhancedInputComponent->BindAction(UseBatteryAction, ETriggerEvent::Started, 
				this, &AMillionnairePlayerBase::OnUseBatteryPressed);
		}
		...
		if (ToggleFlashlightAction)
		{
			EnhancedInputComponent->BindAction(ToggleFlashlightAction, ETriggerEvent::Started, 
				this, &AMillionnairePlayerBase::OnToggleFlashlightPressed);
		}
		if (EquipFlashlightAction)
		{
			EnhancedInputComponent->BindAction(EquipFlashlightAction, ETriggerEvent::Started, 
				this, &AMillionnairePlayerBase::OnEquipFlashlightPressed);
		}
	}
	else
	{
...
void AMillionnairePlayerBase::MoveInput(const FInputActionValue& Value)
{
...
void AMillionnairePlayerBase::LookInput(const FInputActionValue& Value)
{
 ...
 */
void AMillionnairePlayerBase::OnInteractPressed()
{
